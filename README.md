...
The primary aim of this repository is to learn and assist others learn react spring by building fully animated e-commerce react components. This would eventually be connected to a [NestJs](docs.nestjs.com) backend to demonstrate rendering of product data dynamically from backend to frontend.
